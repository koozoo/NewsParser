...
config.set_section_option(section, "DB_HOST", settings.database_.host)
config.set_section_option(section, "DB_PORT", settings.database_.port)
config.set_section_option(section, "DB_USER", settings.database_.login)
config.set_section_option(section, "DB_NAME", settings.database_.name)
config.set_section_option(section, "DB_PASS", settings.database_.pass_)
